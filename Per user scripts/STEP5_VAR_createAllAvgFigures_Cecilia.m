% Script to export all average figures from a STEP4 mat (Cecilia version)
clc
close all
clear
...
typeNames = {'Scotopic 0.025 cd per m2-10-1', 'Scotopic 0.05 cd per m2-4-2', 'Photopic 10 cd per m2-50-3', 'Photoptic 100 cd per m2-50-4'};
...
for rowN = 1:numel(formattedMat)
    ...
    nFlash = formattedMat(rowN).Numberaveraged;
